...
class Actions:
    class FastBlade(ActionBase):
        ...
        def __init__(self, source: 'Actor|None', target: 'Actor|None'):
            ...
            self.damage_potency = 200 if source.job == 'Paladin' and source.level >= 84 else 200  # TODO:original value
    ...
    class RiotBlade(ActionBase):
        ...
        def __init__(self, source: 'Actor|None', target: 'Actor|None'):
            super().__init__(source, target)
            self.damage_potency = 170 if source.job == 'Paladin' and source.level >= 84 else 170  # TODO:original value
            self.combo_damage_potency = 300 if source.job == 'Paladin' and source.level >= 84 else 300  # TODO:original value
    ...
    class RoyalAuthority(ActionBase):
        ...
        def __init__(self, source: 'Actor|None', target: 'Actor|None'):
            super().__init__(source, target)
            self.damage_potency = 130 if source.job == 'Paladin' and source.level >= 84 else 130  # TODO:original value
            self.combo_damage_potency = 420 if source.job == 'Paladin' and source.level >= 84 else 420  # TODO:original value
    ...
    class HolySpirit(ActionBase):
        ...
        def __init__(self, source: 'Actor|None', target: 'Actor|None'):
            ...
            if source.effects.has(Status.Requiescat.id):
                self.damage_potency = 540 if source.job == 'Paladin' and source.level >= 84 else 540  # TODO:original value
            else:
                self.damage_potency = 270 if source.job == 'Paladin' and source.level >= 84 else 270  # TODO:original value
    ...
    class Atonement(ActionBase):
        ...
        def __init__(self, source: 'Actor|None', target: 'Actor|None'):
            super().__init__(source, target)
            self.damage_potency = 420 if source.job == 'Paladin' and source.level >= 84 else 420  # TODO:original value
