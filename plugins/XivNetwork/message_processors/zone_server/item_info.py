...
class ServerItemInfoEvent(NetworkZoneServerEvent):
    id = NetworkZoneServerEvent.id + 'item_info'
    struct_message: ServerItemInfo
...
class ItemInfo(BaseProcessors):
    opcode = "ItemInfo"
    event = ServerItemInfoEvent
